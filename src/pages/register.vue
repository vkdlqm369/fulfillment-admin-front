              ...
              <v-form ref="form" v-model="valid" @submit.prevent>
                ...
                <v-container fluid>
                  ...
                  <v-row class="my-auto">
                    ...
                    <v-col cols="8">
                      <v-text-field variant="outlined" hint="관리자 페이지 접근제한이 필요한 경우 관리자를 선택" persistent-hint density="compact"></v-text-field>
                    </v-col>
                  </v-row>
                  <v-row class="my-auto"> 
                    <v-col cols="4">
                  ...
                  <v-row class="my-auto">
                    ...
                    <v-col cols="8">
                      <v-select :items="['마스터', '관리자']" required dense variant="outlined" density="compact"></v-select>
                    </v-col>
                  </v-row>
