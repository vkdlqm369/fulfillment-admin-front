    ...
    <v-container fluid class="fill-height py-0">
      <v-row justify="center" class="fill-height">
        <v-col cols="12" md="8" lg="6" class="d-flex flex-column fill-height overflow-auto ">
          <v-toolbar flat>
            <v-toolbar-title style="justifycenter">My Page</v-toolbar-title>
            <v-spacer></v-spacer>
          </v-toolbar>
          ...
          <v-card class="flex-grow-1 overflow-y-auto" style="height: 100vh;">
            <v-card-text>
              ...
              <v-row justify="center">
                <v-col cols="auto">
                  <v-btn @click="checkOpen=true; path1=true;" color="primary_blue" class="mt-2">회원 정보 수정</v-btn>
                </v-col>
                <v-col cols="auto">
                  <v-btn @click="checkOpen=true; path1=false;" color="tertiary_red" class="mt-2">비밀번호 수정</v-btn>
                </v-col>
              </v-row>
            </v-card-text>
          </v-card>
